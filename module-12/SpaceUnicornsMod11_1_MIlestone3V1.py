...
def main():
    ...
    #using our .env file
    secrets = dotenv_values("c:/Users/User/csd/csd-310/module-12/.env")
...
def showDistributorWineOrdersRpt (cursor):
    ...
    #Create a list of header labels
    header = ['Distributor', 'Wine Type', 'Total Cases', "Average Order Size"]

    #Build report query
    stQry = "SELECT 	b.distributor_name as Distributor, " +\
		        "d.wine_name as Wine, " +\
                "SUM(a.qty) 'Cases Ordered', " +\
                "AVG(a.qty) 'Average Cases Ordered' " +\
    ...
    colign = ['right', 'left', 'center', 'center'] #Build alignment list
